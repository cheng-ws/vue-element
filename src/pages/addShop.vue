...
<!--&lt;!&ndash;						:action="baseUrl + '/v1/addimg/shop'"&ndash;&gt;-->
<!--                        <el-upload-->
...
<!--                                :before-upload="beforeAvatarUpload">-->
<!--&lt;!&ndash;                            <img v-if="formData.business_license_image"&ndash;&gt;-->
<!--&lt;!&ndash;                                 :src="baseImgPath + formData.business_license_image" class="avatar">&ndash;&gt;-->
...
<!--                                :before-upload="beforeAvatarUpload">-->
<!--&lt;!&ndash;                            <img v-if="formData.catering_service_license_image"&ndash;&gt;-->
<!--&lt;!&ndash;                                 :src="baseImgPath + formData.catering_service_license_image" class="avatar">&ndash;&gt;-->
<!--&lt;!&ndash;                            <i v-else class="el-icon-plus avatar-uploader-icon"></i>&ndash;&gt;-->
<!--							<i  class="el-icon-plus avatar-uploader-icon"></i>-->
<!--						</el-upload>-->
